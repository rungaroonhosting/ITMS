...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('agreements', function (Blueprint $table) {
            ...
            $table->foreignId('type_id')->constrained('agreement_types')->onDelete('restrict');
            $table->string('vendor_name');
            $table->string('vendor_contact_person')->nullable();
            $table->string('vendor_email')->nullable();
            $table->string('vendor_phone', 20)->nullable();
            $table->foreignId('owner_id')->constrained('employees')->onDelete('restrict');
            ...
            $table->index(['end_date']); // For renewal notifications
